...
{
    public partial class RetailDistributorCommissionCtrl : BaseUserControl
    {
        private DataGridViewPagingSumCtrl dataGridViewPagingSumCtrl;

        public RetailDistributorCommissionCtrl()
        {
            InitializeComponent();
            MenuPermission =RolePermissionMenuEnum.佣金查询;
            dataGridViewPagingSumCtrl = new DataGridViewPagingSumCtrl(this.dataGridView1,
                
                dataGridViewPagingSumCtrl_CurrentPageIndexChanged, BaseButtonQuery_Click,
        ...
        private void dataGridViewPagingSumCtrl_CurrentPageIndexChanged(int index)
        {
            if (this.para != null)
            {
               ...
               // dataGridViewPagingSumCtrl.OrderPara = para;
                InteractResult<DistributorCommissionPage>   page = GlobalCache.ServerProxy.GetDistributors4Retail(para); ;
