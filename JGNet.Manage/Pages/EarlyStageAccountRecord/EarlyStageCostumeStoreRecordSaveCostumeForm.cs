...
{
    public partial class EarlyStageCostumeStoreRecordSaveCostumeForm : BaseForm
    {
        private DataGridViewPagingSumCtrl dataGridViewPagingSumCtrl;
        private Costume CurItem { get; set; }
        private String shopID;

        public Action<CostumeStore> SaveClick;

        private OperationEnum action;



        public EarlyStageCostumeStoreRecordSaveCostumeForm(String shopID)
        {
            try
            {
                InitializeComponent();
        ...
        private CostumeStore  curStore;
        public EarlyStageCostumeStoreRecordSaveCostumeForm(CostumeStore store)
        {
            try
            {
                InitializeComponent();
