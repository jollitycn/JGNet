...
{
    public partial class PrintOFreplenishBill : BaseModifyUserControl
    {

        public PrintOFreplenishBill()
        {
            InitializeComponent();
        ...
        private void PrintSettingCtrl_Load(object sender, EventArgs e)
        {
           ...
           // setLblValue(lastPrintSysInfo);
            ...
            InteractResult<PrintTemplateInfo>  result = GlobalCache.ServerProxy.GetPrintTemplateInfo(PrintTemplateType.ReplenishOrder);
        ...
        {
            List<PrintColumnsInfo> list = GlobalUtilOfPrint.getFreplenishBillColumnsInfo();
        ...
        {
            List<PrintSysInfo> list = GlobalUtilOfPrint.getFreplenishBillSysInfo();
      ...
      /*  private void setSysSelectAll()
        ...
        */
        ...
        private void PrintOFreplenishBill_SizeChanged(object sender, EventArgs e)
        {
