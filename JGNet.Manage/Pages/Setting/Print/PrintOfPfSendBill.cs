...
{
    public partial class PrintOfPfSendBill : BaseModifyUserControl
    {

        public PrintOfPfSendBill()
        {
            InitializeComponent();
        ...
        InteractResult<PrintTemplateInfo> result = GlobalCache.ServerProxy.GetPrintTemplateInfo(PrintTemplateType.PfOrder);
        ...
        private void baseButtonSave_Click(object sender, EventArgs e)
        {
           ...
           // PrintColumnInfo p = new PrintColumnInfo();
            ...
            try
            {
                ...
                {
                    Type = PrintTemplateType.PfOrder,
        ...
        private void PrintOfPfSendBill_SizeChanged(object sender, EventArgs e)
        {
