...
{
    public partial class PrintOfCheckStore : BaseModifyUserControl
    {

        public PrintOfCheckStore()
        {
            InitializeComponent();
        ...
        InteractResult<PrintTemplateInfo> result = GlobalCache.ServerProxy.GetPrintTemplateInfo(PrintTemplateType.CheckStoreOrder);
        ...
        {
            List<PrintColumnsInfo> list = GlobalUtilOfPrint.getCheckStoreColumnsInfo();
        ...
        {
            List<PrintSysInfo> list = GlobalUtilOfPrint.getCheckStoreSysInfo();
      ...
      /*  private void setSysSelectAll()
        ...
        */
        ...
        private void baseButtonSave_Click(object sender, EventArgs e)
        {
           ...
           // PrintColumnInfo p = new PrintColumnInfo();
            ...
            try
            {
                ...
                {
                    Type = PrintTemplateType.CheckStoreOrder,
        ...
        private void PrintOfCheckStore_SizeChanged(object sender, EventArgs e)
        {
