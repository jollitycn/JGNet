...
{
    public partial class PrintOfPurchaseStock : BaseModifyUserControl
    {

        public PrintOfPurchaseStock()
        {
            InitializeComponent();
        ...
        InteractResult<PrintTemplateInfo>  result = GlobalCache.ServerProxy.GetPrintTemplateInfo(PrintTemplateType.PurchaseIn);
      ...
      /*  private void setSysSelectAll()
        ...
        */
        ...
        private void baseButtonSave_Click(object sender, EventArgs e)
        {
           ...
           // PrintColumnInfo p = new PrintColumnInfo();
            ...
            try
            {
                ...
                {
                    Type = PrintTemplateType.PurchaseIn,
        ...
        private void PrintOfPurchaseStock_SizeChanged(object sender, EventArgs e)
        {
