...
{
    public partial class PrintOfPurchaseStockReturn : BaseModifyUserControl
    {

        public PrintOfPurchaseStockReturn()
        {
            InitializeComponent();
        ...
        private void PrintSettingCtrl_Load(object sender, EventArgs e)
        {
          ...
          //  setLblValue(lastPrintSysInfo);
            ...
            InteractResult<PrintTemplateInfo>  result = GlobalCache.ServerProxy.GetPrintTemplateInfo(PrintTemplateType.PurchaseOut);
        ...
        {
            List<PrintColumnsInfo> list = GlobalUtilOfPrint.getPurchaseStockReturnColumnsInfo();
        ...
        {
            List<PrintSysInfo> list = GlobalUtilOfPrint.getPurchaseStockSysInfo();
       ...
       /* private void setColSelectAll()
        ...
        private void baseButtonSave_Click(object sender, EventArgs e)
        {
           ...
           // PrintColumnInfo p = new PrintColumnInfo();
            ...
            try
            {
                ...
                {
                    Type = PrintTemplateType.PurchaseOut,
        ...
        private void setLblValue(List<PrintSysInfo> curSysInfo)
        {
            #region
        ...
        private void PrintOfPurchaseStockReturn_SizeChanged(object sender, EventArgs e)
        {
