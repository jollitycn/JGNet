...
{
    public partial class PrintOfAllocateBill : BaseModifyUserControl
    {

        public PrintOfAllocateBill()
        {
            InitializeComponent();
        ...
        InteractResult<PrintTemplateInfo>  result = GlobalCache.ServerProxy.GetPrintTemplateInfo(PrintTemplateType.AllocateOrder);
        ...
        {
            List<PrintColumnsInfo> list = GlobalUtilOfPrint.getAllocateColumnsInfo();
        ...
        {
            List<PrintSysInfo> list = GlobalUtilOfPrint.getAllocateSysInfo();
      ...
      /*  private void setSysSelectAll()
        ...
        */
        ...
        private void baseButtonSave_Click(object sender, EventArgs e)
        {
           ...
           // PrintColumnInfo p = new PrintColumnInfo();
            ...
            try
            {
                ...
                {
                    Type = PrintTemplateType.AllocateOrder,
        ...
        private void PrintOfAllocateBill_SizeChanged(object sender, EventArgs e)
        { 
