...
{
    public partial class ChangePasswordAdminUserCtrl : BaseModifyUserControl
    {
        ...
        public ChangePasswordAdminUserCtrl()
        {
            InitializeComponent();
        ...
        public ChangePasswordAdminUserCtrl(AdminUser adminUser)
        {
            InitializeComponent();
            if (adminUser != null)
            {
