        ...
        static void Main(string[] args)
        {
            try
            {
              ...
              //  MessageBox.Show(args[1]);
                ...
                string serverIP = args[0]; //= ConfigurationManager.AppSettings["ServerIP"];
                int serverPort = Convert.ToInt32( args[1]);//= int.Parse(ConfigurationManager.AppSettings["ServerPort"]);               
                ...
                bool haveRun = CJBasic.Helpers.ApplicationHelper.IsAppInstanceExist(processName);
                if (haveRun)
                {
