    ...
    public class Updater
    {
        ...
        private void UdpateThread()
        {
            try
            {
                ...
                this.rapidPassiveEngine.FileOutter.FileRequestReceived += new CJPlus.Application.FileTransfering.CbFileRequestReceived(fileOutter_FileRequestReceived);
                ...
                this.rapidPassiveEngine.FileOutter.FileReceivingEvents.FileTransCompleted += new CJBasic.CbGeneric<TransferingProject>(FileReceivingEvents_FileTransCompleted);
                ...
                else 
                {
                    ...
                    if (this.removedFileList.Count > 0)
                    {
                        ...
                        {
                            CJBasic.Helpers.FileHelper.DeleteFile(this.appDirPath + file.FileRelativePath);
                        }
                        this.updateConfiguration.Save();
        ...
        void FileReceivingEvents_FileTransDisruptted(TransferingProject transmittingFileInfo, FileTransDisrupttedType fileTransDisrupttedType)
        {
            ...
            CJBasic.Helpers.FileHelper.DeleteDirectory(sourcePath);
            if (this.UpdateDisruptted != null)
            {
